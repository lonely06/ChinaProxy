...
if($request.url.indexOf(`https://heisekeji.cn/game/`) > -1) {
    ...
    function addmoney(userid, key) {
        return new Promise((resolve, reject) => {
			...
			let body = `{"GameId":1,"OpenId":"${userid}","Money":${coin}}`;
    ...
    function shuashua(userid) {
        return new Promise((resolve, reject) => {
			...
			const body = `{"OpenId":"${userid}","GameId":1,"Id":10007}`;
    ...
    function online(userid) {
        return new Promise((resolve, reject) => {
			...
			const body = `{"OpenId":"${userid}","GameId":1}`;
   ...
   //元宝转换余额
    function convertmoney(userid) {
        return new Promise((resolve, reject) => {
			...
			const body = `{"GameId":1,"OpenId":"${userid}","GameCashConfigId":7,"CashType":2}`;
            const request = {
                url: url,
                headers: headers,
                body: body
    ...
    function cash(userid) {
        return new Promise((resolve, reject) => {
            ...
            let body = `{"GameId":1,"OpenId":"${userid}","RedPacket":30,"Desc":"jzack黑色科技"}`;
            const request = {
                url: url,
                headers: headers,
                body: body
